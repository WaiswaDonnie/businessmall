...
function AddPaymentMethodNigeria({navigation}) {
    const METHODS = [
        {
        name: 'FIRST BANK',
        },
    ...
    return (
        <SafeAreaView style={{ flex: 1,backgroundColor:'white' }}>
            ...
            <NavigationHeader showBack={true} label={'Select Payment Method'} />
            <ScrollView style={{ padding: 10 }}>

                <View>
                    {METHODS.map((res,index) => (
                        <TouchableOpacity onPress={()=>{
                            navigation.push('ConfirmTransaction',{bankDetails:res})
...
export default AddPaymentMethodNigeria;
