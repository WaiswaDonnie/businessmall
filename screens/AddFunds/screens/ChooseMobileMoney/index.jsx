...
function ChooseMobileMoney({ navigation }) {
    const METHODS = [
        {
            name: 'MTN',
        },
            ...
            <ScrollView style={{ padding: 10 }}>
                ...
                <View>
                    {METHODS.map((res, index) => (
                        <TouchableOpacity onPress={() => navigation.push('MobileMoney',{name:res.name})} key={index} style={styles.container}>
...
export default ChooseMobileMoney;
